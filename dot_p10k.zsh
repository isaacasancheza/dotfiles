# Generated by Powerlevel10k configuration wizard on 2024-07-19 at 11:08 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # anacond               # conda environment (https://conda.io/)
    # pyen                  # python environment (https://github.com/pyenv/pyenv)
